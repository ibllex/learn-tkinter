...
class Example(ExampleFrame):
    ...
    def init_ui(self):
        ...
        image_kevin = Image.open("/home/i/Downloads/kevin-mueller-6w-jK5Bfz2k-unsplash.jpg").resize((200, 200))
        kevin = ImageTk.PhotoImage(image_kevin)
        label1 = Label(self, image=kevin)
        label1.image = kevin
        label1.place(x=20, y=20)

        image_craig = Image.open("/home/i/Downloads/craig-melville-CY2sDlYLSuE-unsplash.jpg").resize((200, 200))
        craig = ImageTk.PhotoImage(image_craig)
        label2 = Label(self, image=craig)
        label2.image = craig
        label2.place(x=240, y=20)

        image_karl = Image.open("/home/i/Downloads/karl-lee-gM7LYJYrBSw-unsplash.jpg").resize((200, 200))
